                ...
                <div className="footer-content">
                    ...
                    <div className="footer-section">
                        ...
                        <div className="footer-links">
                            ...
                            <a href="tel:+917708644431" className="footer-link contact-footer-item">
                                <Icons.Phone /> +91 7708 644 431
                            </a>
                        ...
                        <div className="social-links footer-social">
                            ...
                            <a href="https://wa.me/917708644431" className="social-btn" aria-label="WhatsApp" title="Chat on WhatsApp">
                                <Icons.WhatsApp />
                            </a>
                        </div>
                    </div>
