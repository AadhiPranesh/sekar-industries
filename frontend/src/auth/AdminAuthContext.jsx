...
export const AdminAuthProvider = ({ children }) => {
    ...
    useEffect(() => {
        const validateToken = async () => {
            ...
            try {
                const response = await fetch('https://sekar-industries.onrender.com/api/auth/verify-admin', {
                    method: 'GET',
                    headers: {
    ...
    const login = async (email, password) => {
        ...
        const response = await fetch('https://sekar-industries.onrender.com/api/auth/login', {
            method: 'POST',
            headers: {
